import numpy as np
import gym
from env_FindTreasure import EnvFindTreasure  # env Class
...
class SubprocVecEnv(object):
    def __init__(self, all_args):
        ...
        self.env_list = [EnvFindTreasure(i) for i in range(all_args.n_rollout_threads)]
    ...
    def step(self, actions):
        ...
        rews, dones, infos, bad_n = zip(*results)

        return np.stack(rews), np.stack(dones), infos, np.stack(bad_n)
