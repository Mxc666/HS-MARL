...
class Action:
    ...
    def __init__(self, name, parameters, positive_preconditions, negative_preconditions, add_effects, del_effects, cond_effects=[]):
        self.name = name
    ...
    def __str__(self):
        ...
        '\n  cond_effects: ' + str(self.cond_effects) + '\n'
    ...
    def groundify(self, objects):
        ...
        for assignment in itertools.product(*type_map):
            ...
            cond_effects = []
            for cond in self.cond_effects:
                eff = {}
                for k, v in cond.items():
                    eff[k] = self.replace(v, variables, assignment)
                cond_effects.append(eff)
            yield Action(self.name, assignment, positive_preconditions, negative_preconditions, add_effects, del_effects, cond_effects)
