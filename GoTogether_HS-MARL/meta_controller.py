...
class SymbolicModel():
    ...
    def generateNumStatePairs(self):
        ...
        NUM_AGENT = 2
        # All state of Agents
        All_numstate = {0: [[1, 0, 0, 0]] * NUM_AGENT,      # r1AtStart, r2AtStart
                       1: [[0, 0, 1, 0], [0, 1, 0, 0]],  # r1NearGoal, r2other
                       2: [[0, 1, 0, 0], [0, 0, 1, 0]],  # r1other, r2NearGoal
                       3: [[0, 0, 1, 0], [0, 0, 1, 0]],  # r1NearGoal, r2NearGoal
                       4: [[0, 0, 0, 1]] * NUM_AGENT}  # r1Goal, r2Goal

        need_list = [(0, 1), (0, 2), (0, 3), (1, 4), (2, 4), (3, 4)]
    ...
    def generateReward(self, action_reward_dict, seed):
        ...
        np.save('../HTN_Planner/intrinsic_reward/GoTogether_HS-MARL/action_reward_' + seed + '.npy',
                action_reward_dict)
    ...
    def generatePlan(self, seed):
        ...
        _ = os.system('sh ../HTN_Planner/cmd_sh/GoTogether_HS-MARL_run_Seed_' + seed +'.sh')

        # update quality and plan
        if flag:  # flag means plan
            flag = False
            p = open('./out/GoTogether_HS-MARL_' + seed +'.out')  # result: plan
            ...
            for i in p.readlines():
                ...
                if flag:
                    ...
                    file_path = '../HTN_Planner/domains/GoTogether_HS-MARL/domain.hddl'
